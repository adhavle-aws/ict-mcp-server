"""
Python backend proxy for CloudFormation MCP Server
Uses FastAPI and working SigV4 implementation
"""
...
# Add parent directory to path to import streamable_http_sigv4
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Python backend proxy starting...")
    print(f"📡 Proxying to: {get_mcp_url()}")
